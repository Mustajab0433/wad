...
document.querySelector('#deposit').addEventListener('keyup', function (e) {
    ...
    if (key === 13) {
        ...
        if(flag && value > 0) {
            ...
            document.querySelector('#deposit-msg').innerHTML = "INValid input";
        }
    }
});
    ...
    if (key === 13) {
        ...
        if(flag && value > 0) {
            if(value > Account.balance) {
                document.querySelector('#withdraw-msg').innerHTML = "You Do not have sufficient amount";
            }
            else {
                withdraw(value);
